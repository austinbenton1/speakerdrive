...
export default function LeadTableRow({ lead, onClick }: LeadTableRowProps) {
  ...
  const handleViewMore = (e: React.MouseEvent) => {
    ...
    if (lead.event_name) params.set('event_name', lead.event_name);
    ...
    <>
      ...
      <div className="px-3 border-t border-gray-200 flex items-center justify-end min-h-[88px]">
        <button
          ...
          title={relatedLeadsCount > 1 ? "View all leads from this event" : "View this lead"}
        >
          ...
          <div className="relative">
            <div className="flex items-center">
              <span className="text-gray-500 group-hover:text-gray-700 transition-colors min-w-[0.875rem] text-center">{relatedLeadsCount}</span>
